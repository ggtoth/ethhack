...
export const freelancerWorkflow = [
  "Register and connect wallet",
...
export const jobs: Job[] = [
  {
    ...
    description:
      "Build a responsive product landing page from the approved Figma direction with polished mobile behavior and production-ready styling.",
    requirements: [
  ...
  },
  {
    ...
    clientRating: "4.7",
    description:
      "Write concise onboarding microcopy for a wallet connection flow, including empty states, errors, and confirmation screens.",
    requirements: [
  ...
  },
  {
    ...
    clientRating: "4.8",
    description:
      "Audit the current escrow dashboard and deliver prioritized UI fixes for clarity, state handling, and mobile layout.",
    requirements: [
...
export const aiReview = {
  ...
  summary:
    "The submission satisfies the core brief, implements the requested responsive sections, and provides source links. Minor polish remains in pricing spacing and footer contrast.",
  matched: [
