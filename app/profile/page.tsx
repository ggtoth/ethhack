    ...
    <section className="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
      <aside className="profile-card rounded-[18px] p-5">
        <div className="grid justify-items-center text-center">
          ...
          <h1 className="mt-4 text-xl font-black">Orbit Labs</h1>
        ...
        <section className="profile-card rounded-[18px] p-5 sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-4xl font-black leading-none">$6,400</h2>
            </div>
...
function Tag({ children }: { children: React.ReactNode }) {
  return (
    <span className="rounded-full bg-[var(--surface-strong)] px-3 py-2 text-[12px] font-bold">
      {children}
    </span>
  );
}
