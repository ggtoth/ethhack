...
(0, node_test_1.describe)("review API route", () => {
    ...
    (0, node_test_1.test)("loads authoritative job and contract details before review", async () => {
        ...
        strict_1.default.match(mockReviewCalls[0].description, /Build a landing page/);
        strict_1.default.match(mockReviewCalls[0].description, /Create a responsive landing page/);
