...
exports.prepareReviewFile = prepareReviewFile;
const node_crypto_1 = require("node:crypto");
async function prepareReviewFile(inputFile, reviewedAt = new Date().toISOString()) {
    ...
    return {
        ...
        reviewedFile: {
            file_id: `pending_${(0, node_crypto_1.randomUUID)()}`,
...
function getImageResolution(buffer, contentType) {
    return (parsePngResolution(buffer, contentType) ||
        parseGifResolution(buffer, contentType) ||
        parseJpegResolution(buffer, contentType) ||
        parseWebpResolution(buffer, contentType) ||
        null);
}
function parsePngResolution(buffer, contentType) {
...
function parseGifResolution(buffer, contentType) {
...
function parseJpegResolution(buffer, contentType) {
...
function parseWebpResolution(buffer, contentType) {
